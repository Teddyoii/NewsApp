package com.judelakshitha.arimacnewsapp.data.remote.adapters

import com.judelakshitha.arimacnewsapp.databinding.ActivityLoginBinding
...
internal class JsonAdapter<T>( val constructor: KFunction<T>,
...
//            }
    ...
    class IndexedParameterMap(val parameterKeys: List<KParameter>, val parameterValues: Array<Any?>): AbstractMap<KParameter, Any?>(){
...
class MyKotlinJsonAdapterFactory : JsonAdapter.Factory {
    override fun create(type: Type, annotations: MutableSet<out Annotation>, moshi: Moshi)
        ...
        val bindingsByName = LinkedHashMap<String, com.judelakshitha.arimacnewsapp.data.remote.adapters.JsonAdapter.Binding<Any, Any?>>()
        ...
        for (property in rawTypeKotlin.memberProperties) {
            ...
            bindingsByName[property.name] =
                com.judelakshitha.arimacnewsapp.data.remote.adapters.JsonAdapter.Binding(
                    name, adapter,
                    property as KProperty1<Any, Any?>, parameter
                )
        }

        val bindings = ArrayList<com.judelakshitha.arimacnewsapp.data.remote.adapters.JsonAdapter.Binding<Any, Any?>?>()
